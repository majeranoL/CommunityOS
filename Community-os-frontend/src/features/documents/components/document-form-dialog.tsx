...
import { useCreateDocument, useUpdateDocument, useUploadFile } from '@/features/documents/hooks/use-documents'
import { documentFormSchema, type DocumentFormValues } from '@/features/documents/validation/document'
import type { DocumentCategory, DocumentListItem } from '@/features/documents/types/document'
...
const CATEGORIES: DocumentCategory[] = ['POLICY', 'MINUTES', 'FINANCIAL', 'NOTICE', 'FORM', 'OTHER']
...
export function DocumentFormDialog({ open, onOpenChange, document }: DocumentFormDialogProps) {
  ...
  const pending = createDocument.isPending || updateDocument.isPending || uploadFile.isPending
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="e.g. Community Rules and Regulations" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
