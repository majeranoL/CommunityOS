...
export class RolesService {
  ...
  async create(communityId: string, dto: CreateRoleDto) {
    // ==========================================
    // Clean Inputs
    // ==========================================
  ...
  async findAll(communityId: string, query: RoleQueryDto) {
  ...
  async update(communityId: string, id: string, dto: UpdateRoleDto) {
    const role = await this.prisma.role.findFirst({
      where: {
        id,
        communityId,
