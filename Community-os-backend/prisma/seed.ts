...
import { BUILTIN_FEATURES, BUILTIN_FEATURE_CONFIGS } from './feature-catalog';
...
async function main() {
  ...
  const featureData = BUILTIN_FEATURES;
  ...
  const optionalFeatureConfigs = BUILTIN_FEATURE_CONFIGS;
